  ...
  return (
    <>
      ...
      >
        ...
        <nav className="px-3 py-4 overflow-y-auto scrollbar-thin flex-1 min-h-0">
        ...
        <div className="shrink-0 flex items-center justify-center opacity-[0.05] pointer-events-none min-h-10">
