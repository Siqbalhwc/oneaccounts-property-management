    ...
    return (
      <AuthShell>
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="card p-6 sm:p-7 space-y-4 text-center border-t-[3px] border-t-brass">
  ...
  return (
    <AuthShell>
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="card p-6 sm:p-7 space-y-4 border-t-[3px] border-t-brass">
